...
public class Exon   {
  ...
  public Exon label(String label) {
    this.label = label;
    return this;
  }
  ...
  **/
  ...
  public Exon categories(List<String> categories) {
  ...
  **/
  ...
  public Exon xrefs(List<String> xrefs) {
    this.xrefs = xrefs;
    return this;
  }
  ...
  **/
  ...
  public Exon sequenceFeatures(List<SequenceFeature> sequenceFeatures) {
  ...
  **/
  ...
  public Exon genes(List<NamedObject> genes) {
    this.genes = genes;
    return this;
  }
   ...
   * @return genes
  **/
  @ApiModelProperty(example = "null", value = "References to any gene objects that have this exon in any of their transcripts")
  ...
  public boolean equals(java.lang.Object o) {
    ...
    Exon exon = (Exon) o;
    return Objects.equals(this.label, exon.label) &&
        Objects.equals(this.id, exon.id) &&
        Objects.equals(this.categories, exon.categories) &&
        Objects.equals(this.xrefs, exon.xrefs) &&
        Objects.equals(this.taxon, exon.taxon) &&
        Objects.equals(this.sequenceFeatures, exon.sequenceFeatures) &&
        Objects.equals(this.genes, exon.genes);
  }

  @Override
  public int hashCode() {
    return Objects.hash(label, id, categories, xrefs, taxon, sequenceFeatures, genes);
  }
